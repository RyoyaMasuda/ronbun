...
結果をセッション JSON に記録する。誤診時は global_lessons に教訓を追記する。
"""
...
from agent_hospital.memory.sessions import append_session_log, finalize_session
...
def run_reflection(task: Any, invocation_state: InvocationState) -> str:
    ...
    Args:
        ...
        invocation_state: 共有状態。patient_id, session_id, diagnosis を参照。
